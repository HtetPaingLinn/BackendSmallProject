    ...
    <div class="w-[200%] ">
        <main class=" max-w-[1000] mx-auto p-10">
            ...
            <section class="bg-gray-100 p-10 mt-6 mb-6 rounded-lg">
                ...
                <a class="inline-flex m-[20px] float-right items-center gap-x-1 text-2l text-blue-600 decoration-2 hover:underline font-medium dark:text-blue-500 mt-[50px]" href="./record-list.php">
                    Show Records
